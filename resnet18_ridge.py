...
experiment.set_name("ResNet18 Ridge")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/resnet18_ridge.pth')


# In[97]:


experiment.log_notebook('resnet18_ridge.ipynb')
experiment.end()
