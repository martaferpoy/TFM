...
experiment.set_name("Efficientnet b2 Ridge")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/efficientnet_b2_ridge.pth')


# In[97]:


experiment.log_notebook('efficientnet_b2_ridge.ipynb')
experiment.end()
