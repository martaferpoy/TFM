...
experiment.set_name("Red propia Ridge 6 capas")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/red_propia_ridge_6capas.pth')


# In[97]:


experiment.log_notebook('red_propia_ridge_6capas.ipynb')
experiment.end()
