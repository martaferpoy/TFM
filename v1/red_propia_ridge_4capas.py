...
experiment.set_name("Red propia Ridge")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/red_propia_ridge.pth')


# In[97]:


experiment.log_notebook('red_propia_ridge.ipynb')
experiment.end()
