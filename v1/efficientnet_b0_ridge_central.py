...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/efficientnet_b0_ridge_central.pth')


# In[97]:


experiment.log_notebook('efficientnet_b0_ridge_central.ipynb')
experiment.end()
