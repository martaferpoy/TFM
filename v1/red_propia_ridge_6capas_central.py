...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/red_propia_ridge_6capas_central.pth')


# In[97]:


experiment.log_notebook('red_propia_ridge_6capas_central.ipynb')
experiment.end()
