...
experiment.set_name("Efficientnet b0 Ridge")
...
model = timm.create_model('efficientnet_b0', pretrained=True, num_classes = 1, in_chans = 6).to(device)
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/efficientnet_b0_ridge.pth')


# In[97]:


experiment.log_notebook('efficientnet_b0_ridge.ipynb')
experiment.end()
