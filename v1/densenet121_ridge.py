...
experiment.set_name("Densenet Ridge")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/densenet121_ridge.pth')


# In[97]:


experiment.log_notebook('densenet121_ridge.ipynb')
experiment.end()
