...
experiment.set_name("ResNet18 Ridge Central")
...
model = timm.create_model('resnet18', pretrained=True, num_classes = 1, in_chans = 6).to(device)
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/resnet18_ridge_central.pth')


# In[97]:


experiment.log_notebook('resnet18_ridge_central.ipynb')
experiment.end()
