...
experiment.set_name("Efficientnet b2 Ridge Central")
...
model = timm.create_model('efficientnet_b2', pretrained=True, num_classes = 1, in_chans = 6).to(device)
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/efficientnet_b2_ridge_central.pth')


# In[97]:


experiment.log_notebook('efficientnet_b2_ridge_central.ipynb')
experiment.end()
