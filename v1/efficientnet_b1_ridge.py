...
experiment.set_name("Efficientnet b1 Ridge")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/efficientnet_b1_ridge.pth')


# In[97]:


experiment.log_notebook('efficientnet_b1_ridge.ipynb')
experiment.end()
