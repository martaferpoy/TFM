...
experiment.set_name("REGRESION red propia 4 capas CENTRAL reg_lin BISP WHOLE SIGNAL")
...
class ConvNet(nn.Module): 
    def __init__(self):
        ...
        self.lin = nn.Linear(in_features = 968256, out_features = 1) 
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_red_propia_4c_reg_lin_whole_signal_bisp_CENTRAL.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_red_propia_4c_reg_lin_whole_signal_bisp_CENTRAL.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_red_propia_4c_reg_lin_whole_signal_bisp_CENTRAL.ipynb')
experiment.end()
