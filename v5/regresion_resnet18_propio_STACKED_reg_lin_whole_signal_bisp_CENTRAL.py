...
experiment.set_name("REGRESION ResNet18 propio STACKED reg_lin BISP WHOLE SIGNAL CENTRAL")
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        x = torch.cat([thorres, abdores], axis = 2)
...
model = ResNet18(3, ResBlock, outputs=1).to(device)
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_resnet18_propio_STACKED_reg_lin_whole_signal_bisp_CENTRAL.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_resnet18_propio_STACKED_reg_lin_whole_signal_bisp_CENTRAL.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_resnet18_propio_STACKED_reg_lin_whole_signal_bisp_CENTRAL.ipynb')
experiment.end()
