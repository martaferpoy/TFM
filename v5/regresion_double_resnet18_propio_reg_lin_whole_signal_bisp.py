...
experiment.set_name("REGRESION Double ResNet18 propio reg_lin BISP WHOLE SIGNAL")
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        y = torch.Tensor([y_ahi_ind]).float()
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_double_resnet18_propio_reg_lin_whole_signal_bisp.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_double_resnet18_propio_reg_lin_whole_signal_bisp.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_double_resnet18_propio_reg_lin_whole_signal_bisp.ipynb')
experiment.end()
