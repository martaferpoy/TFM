...
experiment.set_name("REGRESION red propia 6 capas reg_lin BISP WHOLE SIGNAL")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_red_propia_6c_reg_lin_whole_signal_bisp.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_red_propia_6c_reg_lin_whole_signal_bisp.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_red_propia_6c_reg_lin_whole_signal_bisp.ipynb')
experiment.end()
