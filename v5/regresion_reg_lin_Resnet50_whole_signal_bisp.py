...
experiment.set_name("REGRESION ResNet 50 propio reg_lin BISP WHOLE SIGNAL")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_reg_lin_Resnet50_whole_signal_bisp.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_reg_lin_Resnet50_whole_signal_bisp.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_reg_lin_Resnet50_whole_signal_bisp.ipynb')
experiment.end()
