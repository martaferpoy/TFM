...
experiment.set_name("REGRESION EfficientNetB1 CENTRAL propio reg_lin BISP WHOLE SIGNAL")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_reg_lin_EfficientNetB1_whole_signal_bisp_CENTRAL.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_reg_lin_EfficientNetB1_whole_signal_bisp_CENTRAL.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_reg_lin_EfficientNetB1_whole_signal_bisp_CENTRAL.ipynb')
experiment.end()
