...
experiment.set_name("REGRESION CENTRAL ResNetRS propio reg_lin BISP WHOLE SIGNAL")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_resnet18_propio_reg_lin_ResNetRS_whole_signal_bisp_CENTRAL.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_regresion_resnet18_propio_reg_lin_ResNetRS_whole_signal_bisp_CENTRAL.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_resnet18_propio_reg_lin_ResNetRS_whole_signal_bisp_CENTRAL.ipynb')
experiment.end()
