...
experiment.set_name("REGRESION ResNet18 propio reg_lin BISP WHOLE SIGNAL MSE LOSS CENTRAL")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_resnet18_propio_reg_lin_whole_signal_bisp_MSE_LOSS_CENTRAL.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_resnet18_propio_reg_lin_whole_signal_bisp_MSE_LOSS_CENTRAL.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_resnet18_propio_reg_lin_whole_signal_bisp_MSE_LOSS_CENTRAL.ipynb')
experiment.end()
