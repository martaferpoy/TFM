...
experiment.set_name("REGRESION red propia 6 capas CENTRAL reg_lin BISP WHOLE SIGNAL")
...
class ConvNet(nn.Module): 
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(in_channels = 6, out_channels = 8, kernel_size = 5, stride= 1, padding=0) ,
        ...
        self.lin = nn.Linear(in_features = 256*107*107, out_features = 1) 
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_red_propia_6c_reg_lin_whole_signal_bisp_CENTRAL.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_red_propia_6c_reg_lin_whole_signal_bisp_CENTRAL.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_red_propia_6c_reg_lin_whole_signal_bisp_CENTRAL.ipynb')
experiment.end()
