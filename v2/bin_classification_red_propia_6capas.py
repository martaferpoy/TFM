...
experiment.set_name("Red propia 6 capas bin classification")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_red_propia_6capas.pth')


# In[97]:


experiment.log_notebook('bin_classification_red_propia_6capas.ipynb')
experiment.end()
