...
experiment.set_name("Efficientnet b1 bin classification Central")
...
model = timm.create_model('efficientnet_b1', pretrained=True, num_classes = 2, in_chans = 6).to(device)
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_efficientnet_b1_central.pth')


# In[97]:


experiment.log_notebook('bin_classification_efficientnet_b1_central.ipynb')
experiment.end()
