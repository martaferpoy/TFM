...
experiment.set_name("ResNet18 bin classification threshold 10")
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        y = torch.tensor(0) if y_events_ind < 10 else torch.tensor(1)
...
class_weights = torch.FloatTensor([prop1, prop0]).to(device)
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_resnet18_thres_10.pth')


# In[97]:


experiment.log_notebook('bin_classification_resnet18_thres_10.ipynb')
experiment.end()
