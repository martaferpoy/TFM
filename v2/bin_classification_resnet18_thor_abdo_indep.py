...
experiment.set_name("ResNet18 bin classification independent thorres abdores")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_resnet18_thor_abdo_indep.pth')


# In[97]:


experiment.log_notebook('bin_classification_resnet18_thor_abdo_indep.ipynb')
experiment.end()
