...
experiment.set_name("DenseNet 121 CENTRAL bin classification")
...
model = timm.create_model('densenet121', pretrained=True, num_classes = 2, in_chans = 6).to(device)
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_CENTRAL_densenet121.pth')


# In[97]:


experiment.log_notebook('bin_classification_CENTRAL_densenet121.ipynb')
experiment.end()
