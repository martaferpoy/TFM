...
experiment.set_name("ResNet18 bin classification CENTRAL double encoder")
...
class DoubleEncoderNetwork(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.model_1 = timm.create_model('resnet18', pretrained=True, num_classes = 2, in_chans = 3)
        self.model_2 = timm.create_model('resnet18', pretrained=True, num_classes = 2, in_chans = 3)
        ...
        self.fc = torch.nn.Linear(in_features=1024, out_features=2, bias=True)
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_CENTRAL_resnet18_double_encoder.pth')


# In[97]:


experiment.log_notebook('bin_classification_CENTRAL_resnet18_double_encoder.ipynb')
experiment.end()
