...
experiment.set_name("ResNet18 bin classification CENTRAL propio FitOneCycle Ponderado Threshold 1")
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        y = torch.tensor(0) if y_central_ind <= 1 else torch.tensor(1)
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_resnet18_propio-FitOneCycle-Ponderado-Thres1-CENTRAL.pth')


# In[97]:


experiment.log_notebook('bin_classification_resnet18_propio-FitOneCycle-Ponderado-Thres1-CENTRAL.ipynb')
experiment.end()
