...
experiment.set_name("ResNet18 bin classification CENTRAL thorres")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_CENTRAL_resnet18_thorres.pth')


# In[97]:


experiment.log_notebook('bin_classification_CENTRAL_resnet18_thorres.ipynb')
experiment.end()
