...
experiment.set_name("ResNet18 bin classification CENTRAL random weight init")
...
model = timm.create_model('resnet18', pretrained=False, num_classes = 2, in_chans = 6).to(device)
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_CENTRAL_resnet18_rand_init.pth')


# In[97]:


experiment.log_notebook('bin_classification_CENTRAL_resnet18_rand_init.ipynb')
experiment.end()
