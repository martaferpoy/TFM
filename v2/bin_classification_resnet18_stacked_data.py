...
experiment.set_name("ResNet18 bin classification stacked data")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_resnet18_stacked_data.pth')


# In[97]:


experiment.log_notebook('bin_classification_resnet18_stacked_data.ipynb')
experiment.end()
