...
experiment.set_name("Red propia 4 capas bin classification")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_red_propia_4capas.pth')


# In[97]:


experiment.log_notebook('bin_classification_red_propia_4capas.ipynb')
experiment.end()
