...
experiment.set_name("Red propia 4 capas bin classification Central")
...
class ConvNet(nn.Module): 
    def __init__(self):
        ...
        self.lin = nn.Linear(in_features = 968256, out_features = 2) 
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_red_propia_4capas_central.pth')


# In[97]:


experiment.log_notebook('bin_classification_red_propia_4capas_central.ipynb')
experiment.end()
