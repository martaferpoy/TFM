...
experiment.set_name("DenseNet 121 bin classification")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_densenet121.pth')


# In[97]:


experiment.log_notebook('bin_classification_densenet121.ipynb')
experiment.end()
