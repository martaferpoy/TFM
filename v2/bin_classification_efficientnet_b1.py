...
experiment.set_name("Efficientnet b1 bin classification")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_efficientnet_b1.pth')


# In[97]:


experiment.log_notebook('bin_classification_efficientnet_b1.ipynb')
experiment.end()
