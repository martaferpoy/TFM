...
experiment.set_name("ResNet18 bin classification")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_resnet18.pth')


# In[97]:


experiment.log_notebook('bin_classification_resnet18.ipynb')
experiment.end()
