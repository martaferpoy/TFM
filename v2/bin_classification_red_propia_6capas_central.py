...
experiment.set_name("Red propia 6 capas bin classification Central")
...
class ConvNet(nn.Module): 
    def __init__(self):
        ...
        self.lin = nn.Linear(in_features = 256*107*107, out_features = 2) 
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_red_propia_6capas_central.pth')


# In[97]:


experiment.log_notebook('bin_classification_red_propia_6capas_central.ipynb')
experiment.end()
