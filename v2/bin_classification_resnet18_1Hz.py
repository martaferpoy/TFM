...
experiment.set_name("ResNet18 bin classification 1Hz")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_resnet18_1Hz.pth')


# In[97]:


experiment.log_notebook('bin_classification_resnet18_1Hz.ipynb')
experiment.end()
