...
experiment.set_name("ResNet18 bin classification fit one cycle")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/bin_classification_resnet18_one_cycle.pth')


# In[97]:


experiment.log_notebook('bin_classification_resnet18_one_cycle.ipynb')
experiment.end()
