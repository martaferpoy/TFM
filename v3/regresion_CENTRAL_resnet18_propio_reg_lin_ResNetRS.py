...
experiment.set_name("REGRESION CENTRAL ResNet18 propio reg_lin ResNetRS")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_CENTRAL_resnet18_propio_reg_lin_ResNetRS.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_CENTRAL_resnet18_propio_reg_lin_ResNetRS.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_CENTRAL_resnet18_propio_reg_lin_ResNetRS.ipynb')
experiment.end()
