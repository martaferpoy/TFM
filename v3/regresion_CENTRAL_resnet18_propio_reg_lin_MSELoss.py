...
experiment.set_name("REGRESION CENTRAL ResNet18 propio reg_lin MSE Loss")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_CENTRAL_resnet18_propio_reg_lin_MSELoss.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_CENTRAL_resnet18_propio_reg_lin_MSELoss.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_CENTRAL_resnet18_propio_reg_lin_MSELoss.ipynb')
experiment.end()
