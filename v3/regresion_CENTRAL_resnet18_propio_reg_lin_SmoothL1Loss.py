...
experiment.set_name("REGRESION CENTRAL ResNet18 propio reg_lin Smooth L1 Loss")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_CENTRAL_resnet18_propio_reg_lin_SmoothL1Loss.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_CENTRAL_resnet18_propio_reg_lin_SmoothL1Loss.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_CENTRAL_resnet18_propio_reg_lin_SmoothL1Loss.ipynb')
experiment.end()
