...
experiment.set_name("REGRESION CENTRAL ResNet18 propio reg_lin ConvNeXt")
...
model = timm.create_model('convnext_small.fb_in22k', pretrained=True, num_classes = 1, in_chans = 6).to(device)
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_CENTRAL_resnet18_propio_reg_lin_ConvNeXt.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_CENTRAL_resnet18_propio_reg_lin_ConvNeXt.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_CENTRAL_resnet18_propio_reg_lin_ConvNeXt.ipynb')
experiment.end()
