...
experiment.set_name("REGRESION EfficientNet B1 propio reg_lin")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_efficientNetB1_reg_lin.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_efficientNetB1_reg_lin.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_efficientNetB1_reg_lin.ipynb')
experiment.end()
