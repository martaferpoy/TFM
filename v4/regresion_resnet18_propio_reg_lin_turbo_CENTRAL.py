...
experiment.set_name("REGRESION ResNet18 propio reg_lin TURBO CENTRAL")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_resnet18_propio_reg_lin_turbo_CENTRAL.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_resnet18_propio_reg_lin_turbo_CENTRAL.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_resnet18_propio_reg_lin_turbo_CENTRAL.ipynb')
experiment.end()
