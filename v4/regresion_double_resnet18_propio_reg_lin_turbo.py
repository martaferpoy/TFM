...
experiment.set_name("REGRESION Double ResNet18 propio reg_lin TURBO")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_double_resnet18_propio_reg_lin_turbo.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_double_resnet18_propio_reg_lin_turbo.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_double_resnet18_propio_reg_lin_turbo.ipynb')
experiment.end()
