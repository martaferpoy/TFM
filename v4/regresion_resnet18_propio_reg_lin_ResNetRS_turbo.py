...
experiment.set_name("REGRESION ResNet18 propio reg_lin ResNetRS TURBO")
...
torch.save(best_model.state_dict(), '/home/marta/MsC/trained_models/regresion_resnet18_propio_reg_lin_ResNetRS_turbo.pth')
...
with open('/home/marta/MsC/coefs/coefs_regresion_resnet18_propio_reg_lin_ResNetRS_turbo.txt', 'w') as convert_file:
...
experiment.log_notebook('regresion_resnet18_propio_reg_lin_ResNetRS_turbo.ipynb')
experiment.end()
